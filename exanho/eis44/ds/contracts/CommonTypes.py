...
#
# Generated Sun Jan 10 17:22:36 2021 by generateDS.py version 2.37.11.
...
class commissionMembers(GeneratedsSuper):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'commissionMember': MemberSpec_('commissionMember', 'commissionMemberType', 1, 0, {'maxOccurs': 'unbounded', 'name': 'commissionMember', 'type': 'commissionMemberType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'commissionMember':
            obj_ = commissionMemberType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class commissionMemberType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'role': MemberSpec_('role', 'commissionRoleType', 0, 0, {'name': 'role', 'type': 'commissionRoleType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class purchaseObject(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'quantity': MemberSpec_('quantity', 'quantity', 0, 0, {'name': 'quantity', 'type': 'quantity'}, None),
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'sid' and child_.text:
            ...
            obj_ = quantity.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.quantity = obj_
...
class customerQuantity(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'customer':
            obj_ = organizationRef.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.customer = obj_
...
class quantity(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'undefined': MemberSpec_('undefined', 'xs:boolean', 0, 0, {'fixed': 'true', 'name': 'undefined', 'type': 'xs:boolean'}, 6),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class requirement2020WithAddReqsType(GeneratedsSuper):
    ...
    member_data_items_ = {
        'preferenseRequirementInfo': MemberSpec_('preferenseRequirementInfo', 'prefsReqsRef', 0, 0, {'name': 'preferenseRequirementInfo', 'type': 'prefsReqsRef'}, None),
        'content': MemberSpec_('content', ['text4000Type', 'xs:string'], 0, 1, {'minOccurs': '0', 'name': 'content', 'type': 'xs:string'}, None),
        'reqValue': MemberSpec_('reqValue', ['reqValue', 'xs:double'], 0, 1, {'minOccurs': '0', 'name': 'reqValue', 'type': 'xs:double'}, None),
        'addRequirements': MemberSpec_('addRequirements', 'addRequirements', 0, 1, {'minOccurs': '0', 'name': 'addRequirements', 'type': 'addRequirements'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
...
class reqValue(GeneratedsSuper):
    ...
    def validate_reqValue(self, value):
        result = True
        # Validate type reqValue, a restriction on xs:double.
        pass
        return result
    def hasContent_(self):
        if (
...
class KVRFinancingType(GeneratedsSuper):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'KVR': MemberSpec_('KVR', 'KVRRef', 0, 0, {'name': 'KVR', 'type': 'KVRRef'}, None),
...
class control99CustomerInfoType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'OKOPF': MemberSpec_('OKOPF', 'OKOPFRef', 0, 1, {'minOccurs': '0', 'name': 'OKOPF', 'type': 'OKOPFRef'}, None),
...
class control99NoticeComplianceWithDocType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'responsibleInfo': MemberSpec_('responsibleInfo', 'control99ResponsibleType', 0, 0, {'name': 'responsibleInfo', 'type': 'control99ResponsibleType'}, None),
    ...
    subclass = None
    superclass = None
    def __init__(self, refExternalId=None, documentType=None, refVersionNumber=None, docNumber=None, docDate=None, signDate=None, controlAuthorityInfo=None, customerInfo=None, controlObjectsInfo=None, responsibleInfo=None, extPrintForm=None, bNeedGIISPURCheck=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class values(GeneratedsSuper):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'value': MemberSpec_('value', 'KTRUCharacteristicValueType', 1, 0, {'maxOccurs': 'unbounded', 'name': 'value', 'type': 'KTRUCharacteristicValueType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class rightSideKTRUCharacteristicType(GeneratedsSuper):
    ...
    member_data_items_ = {
        'name': MemberSpec_('name', ['ktruDictNameType', 'xs:string'], 0, 0, {'name': 'name', 'type': 'xs:string'}, None),
        'type_': MemberSpec_('type_', ['ktruCharacteristicTypeType', 'xs:string'], 0, 0, {'name': 'type', 'type': 'xs:string'}, None),
        'value': MemberSpec_('value', 'KTRUCharacteristicValueType', 0, 0, {'name': 'value', 'type': 'KTRUCharacteristicValueType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class tenderPlan2020OKPD2RefType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'undefined': MemberSpec_('undefined', 'xs:string', 0, 0, {'default': '0000', 'name': 'undefined', 'type': 'xs:string'}, 18),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class tenderPlan2020KVRRefType(GeneratedsSuper):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'KVR': MemberSpec_('KVR', 'KVRRef', 0, 0, {'name': 'KVR', 'type': 'KVRRef'}, 19),
        'undefined': MemberSpec_('undefined', 'xs:string', 0, 0, {'default': '000', 'name': 'undefined', 'type': 'xs:string'}, 19),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
class paymentGuaranteeInfoType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'account': MemberSpec_('account', 'paymentPropertysType', 0, 1, {'minOccurs': '0', 'name': 'account', 'type': 'paymentPropertysType'}, None),
    }
    __slots__ = GeneratedsSuper.gds_subclass_slots(member_data_items_)
    subclass = None
    superclass = None
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'attachmentListType'
        rootClass = attachmentListType

...
class export(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'contractProcedure': MemberSpec_('contractProcedure', 'zfcs_contractProcedure2015Type', 1, 0, {'maxOccurs': 'unbounded', 'name': 'contractProcedure', 'type': 'zfcs_contractProcedure2015Type'}, 1),
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
##     if not silence:
##         sys.stdout.write('#from fcsExport import *\n\n')
##         sys.stdout.write('import fcsExport as model_\n\n')

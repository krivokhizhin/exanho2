...
def parse(session, cntr_proc_cancel_obj:zfcs_contractProcedureCancel2015Type, update=True, **kwargs):
    ...
    cancel = session.query(ZfcsContractProcedureCancel2015).\
        filter(ZfcsContractProcedureCancel2015.cancelled_id == cancelled_id, ZfcsContractProcedureCancel2015.cancel_dt == cancel_dt, ZfcsContractProcedureCancel2015.reason == reason).\
            one_or_none()
    ...
    if cancel is None:
        ...
        cancel.court_doc_date = None if cntr_proc_cancel_obj.contractInvalidationCancel is None else cntr_proc_cancel_obj.contractInvalidationCancel.cancelReason.docDate
        cancel.current_stage = cntr_proc_cancel_obj.currentContractStage

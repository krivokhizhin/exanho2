...
from ..model import AddInfoSettings, ProductKind, Product, Client, VkUser, Tariff, OrderStatus, Order, ProductAddInfo, AddInfoCode, LastOrderDetailing
...
def check_and_make_payment(session:OrmSession, order_id:int) -> bool:

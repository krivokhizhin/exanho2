def run():
    ...
    import exanho.eis223.ds.agency_relation as ds_mod
    f = open('/home/kks/projects/eis223DS/agencyRelations/agencyRelations_inc_20180317_000000_001.xml', 'br')
    f_str = f.read()
    rootObj = ds_mod.parseString(f_str)

    from exanho.eis223.parsing.reference.nsi_agency_relations import parse as ds_parse
